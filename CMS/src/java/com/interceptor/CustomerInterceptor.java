...
public class CustomerInterceptor extends ActionSupport implements Interceptor {
    ...
    public String intercept(ActionInvocation ai) throws Exception {
            System.out.println("Intercept method of Customer interceptor called");
		...
		else 
		{
                    System.out.println("Session is Not empty but how");
                     System.out.println("Session is Not empty but how");
			if (!((String) sessionAttributes.get("ID")).equals("") && ((String)sessionAttributes.get("role")).equals("4")) 
			{
				return ai.invoke();
			} 
			else 
