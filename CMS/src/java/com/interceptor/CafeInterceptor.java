...
public class CafeInterceptor extends ActionSupport implements Interceptor {
    ...
    public String intercept(ActionInvocation ai) throws Exception {
		...
		else 
		{
                    System.out.println("Session is Not empty but how");
                     System.out.println("Session is Not empty but how");
			if (!((String) sessionAttributes.get("ID")).equals("") && ((String)sessionAttributes.get("role")).equals("2")) 
			{
				return ai.invoke();
			} 
			else 
