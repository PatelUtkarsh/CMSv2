...
.login-form .footer .register:focus {
 ...
 <s:head />
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="" background="../glare_background_blur_dark_63553_1600x1200.jpg" style="background-position:center;">
 <div style="color: red;">
            <s:actionmessage />
            <s:actionerror />
        </div>
<div id="wrapper">
	...
	<s:form  name="login-form" class="login-form" action="logincheck" method="post">
		...
		<div class="content">
		<s:textfield name="userID"  cssClass="input username" placeholder="Username" />
		...
		<a style="margin-top:2%;" href="signUp"  class="register" /></a>
		</div>
